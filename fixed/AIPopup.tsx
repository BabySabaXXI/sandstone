...
export function AIPopup() {
  ...
  // Generate AI response - memoized to prevent recreations
  ...
  // Load chat history when popup opens - memoized callback
  ...
  }, [aiPopupOpen, user, loadChatHistory]);
  ...
  }, [inputValue, isLoading, generateAIResponse]);
  ...
  }, [aiPopupPosition.x, aiPopupPosition.y]);
